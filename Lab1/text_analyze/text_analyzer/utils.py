...
def get_frequencies_of_words(words):
    response: dict = dict()
...
def get_sentences_words_counts(words_in_sentences) :
    response = list()
...
def get_average_sentence_words_count(sentences_words_count):
    return sum(sentences_words_count) / len(sentences_words_count)


def get_median_sentence_words_count(sentences_words_count):
...
def get_k_grams_for_word(word, length):
    response = list()
...
def get_k_grams_counts(words, k):
    response = dict()
...
def get_most_frequent_k_grams(k_grams_counts, n):
